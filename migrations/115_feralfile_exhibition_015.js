...
module.exports = function (deployer) {
  let exhibition_name = argv.exhibition_name || "Feral File — Ten Whistlegraphs";
  let exhibition_symbol = argv.exhibition_symbol || "FF015";
  let exhibition_edition_size = argv.exhibition_edition_size || 6;
  ...
  deployer.deploy(FeralfileExhibitionV2, exhibition_name, exhibition_symbol,
    ...
    "https://ipfs.bitmark.com/ipfs/QmctAddAjbVUpcCjes5HrEBfMuzM952tnCqfP2cKfPdYam",
