...
module.exports = function (deployer) {
  let exhibition_name = argv.exhibition_name || "Feral File — WETWARE";
  let exhibition_symbol = argv.exhibition_symbol || "FF017";
  let exhibition_edition_size = argv.exhibition_edition_size || 80;
  ...
  deployer.deploy(FeralfileExhibitionV2, exhibition_name, exhibition_symbol,
    ...
    "https://ipfs.bitmark.com/ipfs/QmUry9URE9UBQMbqrrcsBe6pqi6851HNJhBgThGZM2urBR",
