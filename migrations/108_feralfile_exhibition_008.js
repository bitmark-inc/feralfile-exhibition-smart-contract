...
module.exports = function (deployer) {
  let exhibition_name = argv.exhibition_name || "Feral File — Polyarrythmia";
  let exhibition_symbol = argv.exhibition_symbol || "FF008";
  ...
  let exhibition_edition_size = argv.exhibition_edition_size || 90;
  ...
  deployer.deploy(FeralfileExhibitionV2, exhibition_name, exhibition_symbol,
    ...
    "https://ipfs.bitmark.com/ipfs/QmajpnDdx9kGv96pcwuFVEdiDBNkD82W4GNWNJUwoVPRj2",
