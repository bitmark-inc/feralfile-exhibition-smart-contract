...
module.exports = function (deployer) {
  let exhibition_name = argv.exhibition_name || "Feral File — Fragments of a Hologram Rose";
  let exhibition_symbol = argv.exhibition_symbol || "FF003";
  ...
  let exhibition_edition_size = argv.exhibition_edition_size || 77;
  ...
  deployer.deploy(FeralfileExhibitionV2, exhibition_name, exhibition_symbol,
    ...
    "https://ipfs.bitmark.com/ipfs/QmbVzvboSsvp82tJx9StVaYry15RZAVo6hZobwDLpPQKLf",
