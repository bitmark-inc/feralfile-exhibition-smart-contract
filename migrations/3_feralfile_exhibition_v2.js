...
module.exports = function (deployer) {
  let exhibition_name = argv.exhibition_name || "Feral File Dev2 V2 001";
  let exhibition_symbol = argv.exhibition_symbol || "FFDV2001";
  let exhibition_title = argv.exhibition_title || "Feral File Test Exhibition";
  ...
  deployer.deploy(FeralfileExhibitionV2, exhibition_name, exhibition_symbol, exhibition_title,
