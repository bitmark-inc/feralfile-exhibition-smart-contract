...
module.exports = function (deployer) {
  let exhibition_name = argv.exhibition_name || "Feral File — Unsupervised";
  let exhibition_symbol = argv.exhibition_symbol || "FF009";
  ...
  let exhibition_edition_size = argv.exhibition_edition_size || 5000;
