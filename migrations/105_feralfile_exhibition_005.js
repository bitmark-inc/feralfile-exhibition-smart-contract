...
module.exports = function (deployer) {
  let exhibition_name = argv.exhibition_name || "Feral File — Instructions Follow";
  let exhibition_symbol = argv.exhibition_symbol || "FF005";
  ...
  deployer.deploy(FeralfileExhibitionV2, exhibition_name, exhibition_symbol,
    ...
    "https://ipfs.bitmark.com/ipfs/QmQxyKGvNRTcuWbEB5E1tEtNFySHkkD3Qg8biW1ssxvsEp",
