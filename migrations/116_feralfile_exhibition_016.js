...
module.exports = function (deployer) {
  let exhibition_name = argv.exhibition_name || "Feral File — On Screen Presence";
  let exhibition_symbol = argv.exhibition_symbol || "FF016";
  ...
  deployer.deploy(FeralfileExhibitionV2, exhibition_name, exhibition_symbol,
    ...
    "https://ipfs.bitmark.com/ipfs/QmYgQHk9iWVozmktvVBYXGM21TBCKaVkevJCwNddGKaGdE",
