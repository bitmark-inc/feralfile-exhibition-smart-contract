...
module.exports = function (deployer) {
  let exhibition_name = argv.exhibition_name || "Feral File — For Your Eyes Only";
  let exhibition_symbol = argv.exhibition_symbol || "FF011";
  ...
  let exhibition_edition_size = argv.exhibition_edition_size || 115;
  ...
  deployer.deploy(FeralfileExhibitionV2, exhibition_name, exhibition_symbol,
    ...
    "https://ipfs.bitmark.com/ipfs/QmY8KBHKbrnWiGQAtyCjcFN2aqyv3Gwy6AhANjm9hcPt9Q",
