...
module.exports = function (deployer) {
  let exhibition_name = argv.exhibition_name || "Feral File — Infinite Entropy";
  let exhibition_symbol = argv.exhibition_symbol || "FF014";
  let exhibition_edition_size = argv.exhibition_edition_size || 1;
