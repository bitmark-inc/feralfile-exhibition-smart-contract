...
module.exports = function (deployer) {
  let exhibition_name = argv.exhibition_name || "Feral File — P1×3L";
  let exhibition_symbol = argv.exhibition_symbol || "FF006";
  ...
  deployer.deploy(FeralfileExhibitionV2, exhibition_name, exhibition_symbol,
    ...
    "https://ipfs.bitmark.com/ipfs/QmXij77TtbMkuLrLqPDSAZx7arZMj3EaWyE8bszYucTqJe",
