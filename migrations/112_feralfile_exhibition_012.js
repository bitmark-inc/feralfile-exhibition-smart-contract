...
module.exports = function (deployer) {
  let exhibition_name = argv.exhibition_name || "Feral File — Field Guide";
  let exhibition_symbol = argv.exhibition_symbol || "FF012";
  ...
  deployer.deploy(FeralfileExhibitionV2, exhibition_name, exhibition_symbol,
    ...
    "https://ipfs.bitmark.com/ipfs/Qmds44rFRKpj9JaerLAGdPxZ9vDFCGzu7eMmeJyiyLfm8e",
