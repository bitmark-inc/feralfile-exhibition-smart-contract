...
contract('FeralfileExhibitionV3_1', async (accounts) => {
  ...
  it('test build metadata for artwork with IPFS', async function () {
    ...
    assert.equal(metadataJSON.animation_url, "data:text/html;base64,");
  })
  ...
  it('test update artwork external file CIDs with empty CID', async function () {
    let newCid = ""
    let error
    ...
    assert.equal(
      error.message,
      'Returned error: VM Exception while processing transaction: revert thumbnail IPFS CID can not be empty'
    );
  })
